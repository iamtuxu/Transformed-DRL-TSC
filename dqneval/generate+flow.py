...
def generate_xml():
    ...
    #     "customCar2": [(10, "NS"), (10, "WE"), (10, "NS"), (10, "WE")],
    ...
    # multipliers = {
    #     "customCar1": [(0, "NS"), (0, "WE"), (0, "NS"), (0, "WE")],
    #     "customCar2": [(4, "NS"), (4, "WE"), (4, "NS"), (4, "WE")],
    #     "customCar3": [(0, "NS"), (0, "WE"), (0., "NS"), (0, "WE")],
    #     "customCar4": [(0, "NS"), (0, "WE"), (0, "NS"), (0, "WE")]
    # }
    #
    ...
    # multipliers = {
    #     "customCar1": [(0, "NS"), (0, "WE"), (0, "NS"), (0, "WE")],
    #     "customCar2": [(7, "NS"), (7, "WE"), (7, "NS"), (7, "WE")],
    #     "customCar3": [(0, "NS"), (0, "WE"), (0., "NS"), (0, "WE")],
    #     "customCar4": [(0, "NS"), (0, "WE"), (0, "NS"), (0, "WE")]
    # }
    ...
    # ## eval 5 various high
    # multipliers = {
    #     "customCar1": [(10, "NS"), (0, "WE"), (10, "NS"), (0, "WE")],
    #     "customCar2": [(0, "NS"), (4, "WE"), (0, "NS"), (4, "WE")],
    #     "customCar3": [(0, "NS"), (4, "WE"), (0., "NS"), (2, "WE")],
    #     "customCar4": [(0, "NS"), (2, "WE"), (0, "NS"), (4, "WE")]
    # }

    # # eval 6 various low
    # multipliers = {
    #     "customCar1": [(4, "NS"), (0, "WE"), (4, "NS"), (0, "WE")],
    #     "customCar2": [(0, "NS"), (1.5, "WE"), (0, "NS"), (1.5, "WE")],
    #     "customCar3": [(0, "NS"), (1.5, "WE"), (0., "NS"), (1, "WE")],
    #     "customCar4": [(0, "NS"), (1, "WE"), (0, "NS"), (1.5, "WE")]
    # }

    # # eval 7 various medium
    # multipliers = {
    #     "customCar1": [(7, "NS"), (0, "WE"), (7, "NS"), (0, "WE")],
    #     "customCar2": [(0, "NS"), (3, "WE"), (0, "NS"), (3, "WE")],
    #     "customCar3": [(0, "NS"), (3, "WE"), (0., "NS"), (1, "WE")],
    #     "customCar4": [(0, "NS"), (1, "WE"), (0, "NS"), (3, "WE")]
    # }

    # # eval 8 various medium  20241004
    # multipliers = {
    ...
    # # eval 10 various low  20241009
    multipliers = {
        "customCar1": [(5, "NS"), (0, "WE"), (5, "NS"), (0, "WE")],
        "customCar2": [(0, "NS"), (2, "WE"), (0, "NS"), (2, "WE")],
        "customCar3": [(0, "NS"), (2, "WE"), (0., "NS"), (1, "WE")],
        "customCar4": [(0, "NS"), (1, "WE"), (0, "NS"), (2, "WE")]
    }
    ...
    # # ## single saturated
    multipliers = {
        "customCar1": [(7.5, "NS"), (7.5, "WE"), (7.5, "NS"), (7.5, "WE")],
        "customCar2": [(0, "NS"), (0, "WE"), (0, "NS"), (0, "WE")],
        "customCar3": [(0, "NS"), (0, "WE"), (0., "NS"), (0, "WE")],
        "customCar4": [(0, "NS"), (0, "WE"), (0, "NS"), (0, "WE")]
    }
    ...
    for time_range, time_index in zip(time_ranges, range(4)):
        for car_type, multipliers_list in multipliers.items():
            ...
            if multiplier == 0:  # 检查乘数是否为0
                continue  # 如果乘数为0，跳过这个车型和时间段
    ...
    with open('nets/2way-single-intersection/eval2.rou.xml', 'w') as file:
