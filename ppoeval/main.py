...
flags.DEFINE_string('route_file', 'nets/2way-single-intersection/eval6.rou.xml', '')  # Use the evaluation route file
flags.DEFINE_bool('use_gui', True, 'use sumo-gui instead of sumo')
flags.DEFINE_integer('num_episodes', 10, 'Number of evaluation episodes')  # Number of evaluation episodes
flags.DEFINE_string('network_file', 'weights/state2.pth', 'Path to the trained model weights')  # Path to the weights file
