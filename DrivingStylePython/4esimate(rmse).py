...
#     initial_guess = [30, 2.3, 1, 3, 0.8]
#
#     # Define lower and upper bounds for parameters
#     lower_bounds = [15, -1, 0.2, 0.8, 0.3]  # Example lower bounds
#     upper_bounds = [45, 6, 2, 4, 3]  # Example upper bounds
#
...
#         file.write("a: " + str(a_opt) + "\n")
#         file.write("b: " + str(b_opt) + "\n")
...
# Initial guess for parameters
initial_guess = [26.7, 0.3, 0.6, 3, 1.5]

# Define lower and upper bounds for parameters
lower_bounds = [15, -1, 0.4, 0.8, 0.3]  # Example lower bounds
upper_bounds = [35, 5, 2, 3, 3]  # Example upper bounds
